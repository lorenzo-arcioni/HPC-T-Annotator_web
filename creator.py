...
def fill_startbase(processes, threads, inputfile, outformat, diamond, tool, binary, database):
...
def main():
	...
	fill_startbase(processes, threads, inputfile, outformat, diamond, tool, binary, database)
